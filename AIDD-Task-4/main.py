...
st.set_page_config(page_title="PDF Study Agent By Nabeel", page_icon="📚", layout="wide")

st.title("📚 PDF Study Agent By Nabeel")
...
st.markdown("---")
st.markdown(
    "<p style='text-align: center; color: grey;'>Created with ♥️ By Nabeel Ali</p>",

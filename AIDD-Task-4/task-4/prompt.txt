...
1. Initial Setup & Context Retention (IMPORTANT REQUIREMENT)
Documentation Setup
...
Insert the entire contents of this prompt (starting from the “Project Objective” section and ending at the “Final Instruction”) into the GEMINI.md file.
This ensures the agent and LLM always retain the project’s operational context and guidelines.
2. Tech Stack & Environment Configuration
Model & Execution
...
Use PyPDF (pypdf) to extract clean text from PDF uploads with full support for multi-page parsing.
3. Agent Feature (A) — PDF Summarization
User Input
...
Well-structured
summary covering all main ideas and relevant details.

Frontend Output

Display the generated summary in the Streamlit UI using any preferred layout style such as cards, blocks, containers, or expanders.
4. Agent Feature (B) — Quiz Generation
Trigger Condition
...
Include a "Check Answers" button for final evaluation.
...
Ensure the entire app can be executed through a simple command:
